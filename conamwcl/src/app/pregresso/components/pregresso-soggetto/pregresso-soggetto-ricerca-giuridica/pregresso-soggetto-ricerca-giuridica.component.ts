...
@Component({
    selector: 'pregresso-soggetto-ricerca-giuridica',
    templateUrl: './pregresso-soggetto-ricerca-giuridica.component.html'
})
@DestroySubscribers()
export class PregressoSoggettoRicercaGiuridicaComponent implements OnInit {
