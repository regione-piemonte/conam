...
export class RifNormativiService {
    ...
    getAmbitiByIdEnte(idEnte: number, filterDataValidita: boolean, pregresso:boolean = false, dataOraAccertamento:string=''): Observable<Array<AmbitoVO>> {
        ...
        if(pregresso && dataOraAccertamento){
            params = params.set('pregresso','true').set('dataOraAccertamento',dataOraAccertamento);
        }
    ...
    getNormeByIdAmbitoAndIdEnte(idAmbito: number,idEnte: number, filterDataValidita: boolean, pregresso:boolean = false, dataOraAccertamento:string=''): Observable<Array<NormaVO>> {
    ...
    getArticoliByIdNormaAndIdEnte(idNorma: number, idEnte: number, filterDataValidita: boolean, pregresso:boolean = false, dataOraAccertamento:string=''): Observable<Array<ArticoloVO>> {
    ...
    getCommaByIdArticolo(idComma: number, filterDataValidita: boolean, pregresso:boolean = false, dataOraAccertamento:string=''): Observable<Array<CommaVO>> {
    ...
    getLetteraByIdComma(idLettera: number, filterDataValidita: boolean, pregresso:boolean = false, dataOraAccertamento:string=''): Observable<Array<LetteraVO>> {
