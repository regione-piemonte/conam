...
export class OrdinanzaRicercaGestContAmministrativoComponent
  ...
  ricercaOrdinanza(ricercaOrdinanzaRequest: RicercaOrdinanzaRequest) {
    ...
    if (this.itsAnnullamento === "annullamento") {
      this.sharedOrdinanzaService
        .ricercaOrdinanzaAnnullamento(ricercaOrdinanzaRequest)
        .subscribe(
          (data) => {
  ...
  onDettaglio(el: any | Array<any>) {
    ...
    if (el instanceof Array) {
      ...
      this.router.navigate([
        Routing.GESTIONE_CONT_AMMI_ORDINANZA_RIEPILOGO + el.id,
