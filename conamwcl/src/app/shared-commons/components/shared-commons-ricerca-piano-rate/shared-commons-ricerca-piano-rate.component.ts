...
@Component({
  selector: "shared-commons-ricerca-piano-rate",
  templateUrl: "./shared-commons-ricerca-piano-rate.component.html",
  styleUrls: ["./shared-commons-ricerca-piano-rate.component.scss"],
})
export class SharedCommonsRicercaPianoRateComponent implements OnInit, OnDestroy {
  ...
  ngOnInit(): void {
    this.logger.init(SharedCommonsRicercaPianoRateComponent.name);
  ...
  ngOnDestroy(): void {
    this.logger.destroy(SharedCommonsRicercaPianoRateComponent.name);
  }
