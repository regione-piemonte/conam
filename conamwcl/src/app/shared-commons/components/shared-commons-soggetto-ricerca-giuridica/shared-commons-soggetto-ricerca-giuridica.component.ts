...
@Component({
    selector: 'shared-commons-soggetto-ricerca-giuridica',
    templateUrl: './shared-commons-soggetto-ricerca-giuridica.component.html'
})
@DestroySubscribers()
export class SharedCommonsSoggettoRicercaGiuridicaComponent implements OnInit {
