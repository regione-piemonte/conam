...
export class ConfigSharedService implements OnDestroy {
  ...
  getConfigRicercaProtocollo(
    flag: boolean,
    multipleSelection: boolean = false
  ): Config {
    let configRicercaProtocolloTmp = { ...this.configRicercaProtocollo };
    configRicercaProtocolloTmp.selection = {
      ...this.configRicercaProtocollo.selection,
    };
    configRicercaProtocolloTmp.selection.enable = flag;
    if (multipleSelection) {
      configRicercaProtocolloTmp.selection.selectionType =
