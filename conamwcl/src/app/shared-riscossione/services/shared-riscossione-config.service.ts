...
export class SharedRiscossioneConfigService implements OnDestroy {
    ...
    private configRiscossioneOrdinanza: Config = {
        ...
        edit: {            enable: false,            isEditable: (any: any) => false        },
        delete: {            enable: false,            internal: false,            isDeletable: (any: any) => false        },
        info:{            enable: false,            hasInfo: (el: any) => {                return false;            }        },
        columns: [
            ...
            {                columnName: 'nomeCognomeRagioneSociale',                displayName: 'Identificativo Soggetto'             },
            {                columnName: 'ruolo.denominazione',                displayName: 'Ruolo'            },
            {                columnName: 'importoPagatoDaPagarePiano',                displayName: 'Saldo Piano'            },
            {                columnName: 'importoPagatoDaPagareOrdinanza',                displayName: 'Saldo Ordinanza'            },
            {                columnName: 'importoPagatoDaPagareSollecito',                displayName: 'Saldo Sollecito'            },
            {                columnName: 'importoDaRiscuotere',                displayName: 'Importo da riscuotere'            },
