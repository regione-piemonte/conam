...
export class SharedRateConfigService implements OnDestroy {
    ...
    public configViewRate: Config = {
        columns: [
            ...
            {                columnName: 'dataPagamento',                displayName: 'Data Pagamento'            },
            {                columnName: 'importoPagato',                displayName: 'Importo Pagato'            },
            {                columnName: 'dataScadenza',                displayName: 'Data Scadenza'            },
            {                columnName: 'dataFineValidita',                displayName: 'Data fine validità'            },
