...
export class PregressoRiepilogoComponent implements OnInit, OnDestroy {
    ...
    @ViewChild(SharedVerbaleRiepilogoComponent) sharedVerbaleRiepilogoComponent: SharedVerbaleRiepilogoComponent;
    ...
    public azioneVerbale: AzioneVerbalePregressiResponse = new AzioneVerbalePregressiResponse();
    ...
    getAzioneVerbale() {
        this.loaded = false;
        this.subscribers.statoVerbale = this.pregressoVerbaleService.getAzioniVerbale(this.idVerbale).subscribe(data => {
            this.loaded = true;
