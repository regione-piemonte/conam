...
@Component({
    ...
    templateUrl: './fase-giurisdizionale-rateizzazione-ricerca-ordinanza.component.html'
})
export class FaseGiurisdizionaleRateizzazioneRicercaOrdinanzaComponent implements OnInit, OnDestroy {
    ...
    ngOnInit(): void {
        this.logger.init(FaseGiurisdizionaleRateizzazioneRicercaOrdinanzaComponent.name);
    ...
    onDettaglio(el: any | Array<any>) {
        ...
        if (el instanceof Array)
            ...
            this.router.navigateByUrl(Routing.FASE_GIURISDIZIONALE_RATEIZZAZIONE_DETTAGLIO_ORDINANZA + el.id);
    }
    ...
    goToFaseGiurisdizionaleElencoIstanze() {
        this.router.navigateByUrl(Routing.FASE_GIURISDIZIONALE_RATEIZZAZIONE_DETTAGLIO_ORDINANZA);
    }

    ngOnDestroy(): void {
        this.logger.destroy(FaseGiurisdizionaleRateizzazioneRicercaOrdinanzaComponent.name);
    }
