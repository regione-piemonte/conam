...
module.exports = {
  ...
  "entry": {
    ...
    "scripts": [
      ...
      "script-loader!./node_modules/moment/locale/it.js",
    ...
    "rules": [
      ...
      },
      {
        "exclude": [
          ...
          path.join(process.cwd(), "node_modules/eonasdan-bootstrap-datetimepicker/build/css/bootstrap-datetimepicker.min.css"),
          path.join(process.cwd(), "src/styles.scss"),
          path.join(process.cwd(), "src/assets/fonts/font-awesome-4.7.0/css/font-awesome.min.css")
        ],
        "test": /\.css$/,
        "use": [
