...
public class ResponseAggiungiAllegato extends ResponseGestioneDocumenti {
    ...
    // Type metadata
    static { 
        typeDesc = new org.apache.axis.description.TypeDesc(ResponseAggiungiAllegato.class, true);
    }
