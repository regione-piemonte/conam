...
public class CsiLogAudit implements Serializable{
	...
	public enum TraceOperation{
		...
		AGGIORNAMENTO_IMPORTO_SOGGETTI("AGGIORNAMENTO IMPORTO SOGGETTI"),
		INSERIMENTO_NOTA("INSERIMENTO NOTA"),
		MODIFICA_NOTA("MODIFICA NOTA"),
		ELIMINA_NOTA("ELIMINA NOTA"),
		RICERCA_DOCUMENTO_STILO("RICERCA_DOCUMENTO_STILO");
